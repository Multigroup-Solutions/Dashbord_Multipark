// Migration 0065 — Pedidos do Jorge de 2026-09-09:
//
...
export const MIGRATION_0065_NAME = "0065_whatsapp_media_and_handover_clothing";

export const MIGRATION_0065_STATEMENTS: string[] = [
...
export const IDEMPOTENT_ERROR_CODES_0065 = new Set([
