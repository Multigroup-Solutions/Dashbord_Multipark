...
- Na ficha do cliente, na reclamação, no perdido e na reserva há um separador **Comunicações** com os emails (e o WhatsApp) ligados.
...
**Segurança**
- As imagens de fora ficam bloqueadas até carregares em **Mostrar imagens** (evita pixels de rastreio).
